...
it('departure has distance', () => {
    const distance = 100;
    const response = { data: { nearest: { edges: [{ node: { distance, place: { pattern: { route: {} }, stoptimes: [{}]}, pattern: { route: {} } } }] } } };
    const result = parseResponse(response);
...
it('departure has vehicle type', () => {
    ...
    const response = { data: { nearest: { edges: [{ node: { place: { pattern: { route: { mode: vehicleType } }, stoptimes: [{}]}, pattern: { route: {} } } }] } } };
    const result = parseResponse(response);
...
it('departure has route identifier', () => {
    const routeName = '9';
    const response = { data: { nearest: { edges: [{ node: { place: { pattern: { route: { shortName: routeName } }, stoptimes: [{}]}, pattern: { route: {} } } }] } } };
    const result = parseResponse(response);
...
it('departure has destination', () => {
    ...
    const response = { data: { nearest: { edges: [{ node: { place: { pattern: { route: {} }, stoptimes: [{ headsign: destination }]}, pattern: { route: {} } } }] } } };
    const result = parseResponse(response);
...
it('departure has departure time', () => {
    ...
    const response = { data: { nearest: { edges: [{ node: { place: { pattern: { route: {} }, stoptimes: [{ scheduledDeparture }]}, pattern: { route: {} } } }] } } };
    const result = parseResponse(response);
...
it('departure time is sum of serviceDay and scheduledDeparture', () => {
    ...
    const response = { data: { nearest: { edges: [{ node: { place: { pattern: { route: {} }, stoptimes: [{ scheduledDeparture, serviceDay }]}, pattern: { route: {} } } }] } } };
    const result = parseResponse(response);
...
it('departure has realtime flag', () => {
    const realtime = true;
    const response = { data: { nearest: { edges: [{ node: { place: { pattern: { route: {} }, stoptimes: [{ realtime }]}, pattern: { route: {} } } }] } } };
    const result = parseResponse(response);
...
it('departure has realtime departure time', () => {
    ...
    const response = { data: { nearest: { edges: [{ node: { place: { pattern: { route: {} }, stoptimes: [{ realtimeDeparture }]}, pattern: { route: {} } } }] } } };
    const result = parseResponse(response);
...
it('realtime departure time is combination of serviceDay and realtimeDeparture', () => {
    ...
    const response = { data: { nearest: { edges: [{ node: { place: { pattern: { route: {} }, stoptimes: [{ realtimeDeparture, serviceDay }]}, pattern: { route: {} } } }] } } };
    const result = parseResponse(response);
