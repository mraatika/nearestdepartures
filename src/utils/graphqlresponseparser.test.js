...
it('returns an array containing an object when response data.nearest.edges has one node', () => {
    const response = { data: { nearest: { edges: [{ node: { place: { pattern: { route: {} }, stoptimes: [{ trip: {} }]} } }] } } };
...
it('returns an array with as many members as there are nodes', () => {
    const edges = [
        { node: { place: { pattern: { route: {} }, stoptimes: [{ trip: {} }]} } },
        { node: { place: { pattern: { route: {} }, stoptimes: [{ trip: {} }]} } },
    ];
...
it('returns exclude departure if there are no stoptimes', () => {
    const edges = [
        { node: { place: { pattern: { route: {} }, stoptimes: [] } } },
        { node: { place: { pattern: { route: {} }, stoptimes: [{ trip: {} }] } } },
    ];
    const response = { data: { nearest: { edges } } };
    const result = parseResponse(response);
...
it('departure has id', () => {
    const id = 'abc';
    const response = { data: { nearest: { edges: [{ node: { place: { pattern: { route: {} }, stoptimes: [{ trip: { id } }]} } }] } } };
    const result = parseResponse(response);
...
it('departure has url', () => {
    const routeCode = 'abc';
    const stopCode = 'def';
    const response = { data: { nearest: { edges: [{ node: { place: { pattern: { code: stopCode, route: { gtfsId: routeCode } }, stoptimes: [{ trip: {} }]} } }] } } };
    const result = parseResponse(response);
...
it('departure has distance', () => {
    const distance = 100;
    const response = { data: { nearest: { edges: [{ node: { distance, place: { pattern: { route: {} }, stoptimes: [{ trip: {} }]} } }] } } };
    const result = parseResponse(response);
...
it('departure has vehicle type', () => {
    ...
    const response = { data: { nearest: { edges: [{ node: { place: { pattern: { route: { mode: vehicleType } }, stoptimes: [{ trip: {} }]} } }] } } };
    const result = parseResponse(response);
...
it('departure has route identifier', () => {
    const routeName = '9';
    const response = { data: { nearest: { edges: [{ node: { place: { pattern: { route: { shortName: routeName } }, stoptimes: [{ trip: {} }]} } }] } } };
    const result = parseResponse(response);
...
it('departure has destination', () => {
    ...
    const response = { data: { nearest: { edges: [{ node: { place: { pattern: { route: {} }, stoptimes: [{ headsign: destination, trip: {} }]} } }] } } };
    const result = parseResponse(response);
...
it('departure has destination from route if stoptimes headsign is null', () => {
    ...
    const response = { data: { nearest: { edges: [{ node: { place: { pattern: { headsign: destination, route: {} }, stoptimes: [{ headsign: null, trip: {} }]} } }] } } };
    const result = parseResponse(response);
    expect(result[0].destination).toBe(destination);
});
...
it('departure has departure time', () => {
    ...
    const response = { data: { nearest: { edges: [{ node: { place: { pattern: { route: {} }, stoptimes: [{ scheduledDeparture, trip: {} }]} } }] } } };
    const result = parseResponse(response);
...
it('departure time is sum of serviceDay and scheduledDeparture', () => {
    ...
    const response = { data: { nearest: { edges: [{ node: { place: { pattern: { route: {} }, stoptimes: [{ scheduledDeparture, serviceDay, trip: {} }]} } }] } } };
    const result = parseResponse(response);
...
it('departure has realtime flag', () => {
    const realtime = true;
    const response = { data: { nearest: { edges: [{ node: { place: { pattern: { route: {} }, stoptimes: [{ realtime, trip: {} }]} } }] } } };
    const result = parseResponse(response);
...
it('departure has realtime departure time', () => {
    ...
    const response = { data: { nearest: { edges: [{ node: { place: { pattern: { route: {} }, stoptimes: [{ realtimeDeparture, trip: {} }]} } }] } } };
    const result = parseResponse(response);
...
it('realtime departure time is combination of serviceDay and realtimeDeparture', () => {
    ...
    const response = { data: { nearest: { edges: [{ node: { place: { pattern: { route: {} }, stoptimes: [{ realtimeDeparture, serviceDay, trip: {} }]} } }] } } };
    const result = parseResponse(response);
...
it('returns as many rows as there are stoptimes', () => {
    ...
    const response = { data: { nearest: { edges: [{ node: { place: { pattern: { route: {} }, stoptimes } } }] } } };
    const result = parseResponse(response);
